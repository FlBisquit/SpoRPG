...
func cast() -> void:
	...
	instance.caster_name = player_name
	...
	cooldowns[current_spell_name] = instance.cooldown * stats.get("cooldown", 1.0)
	if instance.is_projectile:
		...
		print("camera forward: ", -camera_3d.global_transform.basis.z)
